    ...
    <div class="min-h-screen bg-[#F7F3E6] py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-3xl mx-auto bg-white p-8 rounded-xl shadow-lg">
            ...
            <form action="{{ route('devis.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    <label for="description" class="block text-sm font-medium text-[#05335E]">Description
                        (optionnelle)</label>
                    <textarea name="description" id="description" rows="4"
                        class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm py-3 px-4 focus:ring-[#2C3E50] focus:border-[#2C3E50]">{{ old('description') }}</textarea>
                </div>

                <div>
                    <label for="image" class="block text-sm font-medium text-[#05335E]">Image d'inspiration
                        (optionnelle)</label>
                    <input type="file" name="image" id="image" accept="image/*"
                        class="  text-[#05335E] mt-1 block w-full border border-gray-300 rounded-lg shadow-sm py-2 px-4 text-sm focus:ring-[#2C3E50] focus:border-[#2C3E50]">
                </div>
                ...
                <div class="pt-4">
                    <button type="submit"
                        class="w-full bg-[#05335E] text-white py-3 px-6 rounded-lg hover:bg-[#C19B2C] transition-colors duration-300 font-semibold">
                        Envoyer la demande
                    </button>
                </div>
            </form>
