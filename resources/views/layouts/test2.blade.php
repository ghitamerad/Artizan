            ...
            <div class="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10">
                    ...
                    <div class="hidden md:flex items-center space-x-4">
                        ...
                        @auth
                            ...
                            <div class="relative group">
                                <button onclick="toggleMenu()" class="flex items-center text-[#05335E] hover:text-[#C19B2C] focus:outline-none">
                                ...
                                <div id="user-menu" class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg hidden">
                                    <a href="{{ route('dashboard') }}"
                                       class="block px-4 py-2 text-[#05335E] hover:bg-[#C19B2C] hover:text-white">Tableau de bord</a>
                ...
                <div id="mobile-menu" class="md:hidden hidden flex-col space-y-2 mt-2">
                    ...
                    @auth
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit" class="block w-full text-left text-[#05335E] font-medium">Déconnexion</button>
                        </form>
                    @else
