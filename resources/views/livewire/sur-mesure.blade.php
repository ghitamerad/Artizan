                        ...
                        <div class="flex flex-col gap-3">
                            ...
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 10l4.586-4.586a2 2 0 012.828 0L22 10m-2-2l1.586-1.586a2 2 0 012.828 0L26 8m-2-2h.01M8 22h12a2 2 0 002-2V8a2 2 0 00-2-2H8a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                </svg>
                                Personnaliser
                            </button>
                        </div>
