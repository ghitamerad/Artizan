        ...
        <div
            ...
            @endif
                <div class="p-6">
                    ...
                    <span class="bg-[#D4AF37] text-white px-3 py-1 rounded-full text-sm">{{ $modele->categorie->nom }}</span>
                    <div class="text-2xl font-bold text-[#2C3E50]">{{ number_format($modele->prix, 2, ',', ' ') }} €</div>
