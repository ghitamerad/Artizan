<div x-data="{ open: false }" class="relative">
    <!-- Bouton du panier -->
    <button @click="open = !open" class="p-2 bg-[#05335E] text-blue rounded-full shadow-lg hover:bg-[#C19B2C] transition duration-300 ease-in-out">
    ...
    <div x-show="open" @click.away="open = false" class="absolute right-0 mt-2 w-64 bg-white rounded-lg shadow-lg">
        <div class="p-4">
            ...
            <a href="{{ route('panier') }}" class="mt-4 w-full bg-[#D4AF37] text-white py-1 px-2 rounded-lg hover:bg-[#05335E] block text-center">
                Afficher
            </a>
        </div>
    </div>
